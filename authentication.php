    ...
    <div class="container" style="padding-top:150px;">
      <div class="row">
        ...
        <div class="col-sm-4 text-center" style="border:2px solid gray;padding:50px;">
          ...
          $hostname = "localhost";
          $username = "root";
          // Usar $_ENV para obtener la variable de entorno
          $password = isset($_ENV['DB_PASSWORD']) ? $_ENV['DB_PASSWORD'] : null;
          $database = "db_evoting";

          // Mensaje de error si la variable no está definida
          if (!$password) {
              echo "<p class='alert alert-danger'><strong>Error: la variable DB_PASSWORD no está definida en el archivo .env</strong></p>";
              exit;
          }
